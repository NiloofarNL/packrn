...
NULL
#' packrn: A package with a minimum example of package creation.
#'
...
#' @docType package
#' @name packrn-package
#' @author Niloofar Nalaee, School of Earth, Environment and Society, McMaster University \email{paezha@@mcmaster.ca}
#' @references \url{https://github.com/NiloofarNL/packrn}
#' @concept Assignment
NULL
